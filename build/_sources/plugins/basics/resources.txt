...
So if an image were located at blocks/plugins/cocktailrecipes/resources/images/gin.png, it would be acccessible via ``UrlHelper::getResourceUrl('cocktailrecipes/images/gin.png')`` and ``{{ resourceUrl('cocktailrecipes/images/gin.png') }}``.
