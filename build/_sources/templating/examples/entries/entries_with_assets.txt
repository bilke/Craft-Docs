...
Now head to ``Settings`` > ``Sections`` > and click on the Section for which you wish to include your images.  For this example, we'll work with a section called "Articles".  Click on the Articles Section, then click on ``Blocks``.
...
Now, you can head over to ``Content`` and create a ``New Entry`` in that Section. You will see the New Entry form, including your Links block for your images.  Click the Add Image button and upload some images, and fill out any other Blocks on that page.
