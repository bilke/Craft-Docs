...
2. Upload the craft/ folder to the folder above the web root on your server.

    .. container:: tip

       Make sure your FTP client is set to upload files in ASCII format.

2. Upload the contents of the public/ folder into the web root of your server.
...
2. Upload craft/app-new/ to your server’s craft/ folder.
